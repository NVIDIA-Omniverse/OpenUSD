...
static UsdContrivedEmptyMultipleApplyAPI_CanApplyResult
...
void wrapUsdContrivedEmptyMultipleApplyAPI()
{
    ...
    UsdContrivedEmptyMultipleApplyAPI_CanApplyResult::Wrap<UsdContrivedEmptyMultipleApplyAPI_CanApplyResult>(
