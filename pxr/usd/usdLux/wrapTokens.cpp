...
void wrapUsdLuxTokens()
{
    ...
    _ADD_TOKEN(cls, physicalCustomIlluminant);
    _ADD_TOKEN(cls, physicalIlluminant);
    _ADD_TOKEN(cls, photometricIlluminance);
    _ADD_TOKEN(cls, photometricIlluminanceDistance);
    _ADD_TOKEN(cls, photometricPower);
    ...
    _ADD_TOKEN(cls, PhysicalLightIlluminantAPI);
    _ADD_TOKEN(cls, PhotometricAreaLightAPI);
    _ADD_TOKEN(cls, PhotometricDomeLightAPI);
    _ADD_TOKEN(cls, PhotometricDistantLightAPI);
