...
TF_WRAP(UsdLuxPhysicalLightIlluminantAPI);
TF_WRAP(UsdLuxPhotometricAreaLightAPI);
TF_WRAP(UsdLuxPhotometricDomeLightAPI);
TF_WRAP(UsdLuxPhotometricDistantLightAPI);
