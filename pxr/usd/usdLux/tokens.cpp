...
UsdLuxTokensType::UsdLuxTokensType() :
    ...
    blackbody("blackbody", TfToken::Immortal),
    ...
    illuminantD("illuminant D", TfToken::Immortal),
    ...
    physicalCustomIlluminant("physical:customIlluminant", TfToken::Immortal),
    physicalIlluminant("physical:illuminant", TfToken::Immortal),
    photometricIlluminance("photometric:illuminance", TfToken::Immortal),
    photometricIlluminanceDistance("photometric:illuminance:distance", TfToken::Immortal),
    photometricPower("photometric:power", TfToken::Immortal),
    ...
    PhysicalLightIlluminantAPI("PhysicalLightIlluminantAPI", TfToken::Immortal),
    PhotometricAreaLightAPI("PhotometricAreaLightAPI", TfToken::Immortal),
    PhotometricDomeLightAPI("PhotometricDomeLightAPI", TfToken::Immortal),
    PhotometricDistantLightAPI("PhotometricDistantLightAPI", TfToken::Immortal),
    ...
    allTokens({
        ...
        noMaterialResponse,
        orientToStageUpAxis,
        physicalCustomIlluminant,
        physicalIlluminant,
        photometricIlluminance,
