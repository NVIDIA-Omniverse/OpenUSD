...
BSDL_INLINE BSDL_CONFIG::JakobHanikaLut::Coeff
operator*(const BSDL_CONFIG::JakobHanikaLut::Coeff c, float f)
{
    BSDL_CONFIG::JakobHanikaLut::Coeff res;
    for (int i = 0; i != BSDL_CONFIG::JakobHanikaLut::Coeff::NPAD; ++i)
        res.c[i] = c.c[i] * f;
    return res;
}
BSDL_INLINE BSDL_CONFIG::JakobHanikaLut::Coeff
operator*(float f, const BSDL_CONFIG::JakobHanikaLut::Coeff c)
{
    return c * f;
}
BSDL_INLINE BSDL_CONFIG::JakobHanikaLut::Coeff
operator+(const BSDL_CONFIG::JakobHanikaLut::Coeff a,
          const BSDL_CONFIG::JakobHanikaLut::Coeff b)
{
    BSDL_CONFIG::JakobHanikaLut::Coeff res;
    for (int i = 0; i != BSDL_CONFIG::JakobHanikaLut::Coeff::NPAD; ++i)
        res.c[i] = a.c[i] + b.c[i];
...
{
    constexpr int RGB_RES = BSDL_CONFIG::JakobHanikaLut::RGB_RES;
    ...
    const BSDL_CONFIG::JakobHanikaLut::Coeff c
        = LERP(dz,
