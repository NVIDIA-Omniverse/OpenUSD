...
struct Spectrum {
    ...
    static BSDL_INLINE_METHOD ColorSpace get_color_space(float lambda_0)
    {
        if (lambda_0 == 0)
            ...
            switch (BSDL_CONFIG::current_color_space()) {
            case BSDL_CONFIG::ColorSpaceTag::sRGB: return sRGBColorSpace();
            case BSDL_CONFIG::ColorSpaceTag::ACEScg: return ACEScgColorSpace();
...
struct Power {
    ...
    static constexpr unsigned N = BSDL_CONFIG::HERO_WAVELENGTH_CHANNELS;
