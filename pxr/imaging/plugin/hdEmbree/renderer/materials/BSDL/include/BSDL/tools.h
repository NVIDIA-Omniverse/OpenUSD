...
{
    float s = BSDL_CONFIG::Fast::sinf(angle), c = BSDL_CONFIG::Fast::cosf(angle);
...
{
    constexpr auto fast_exp2 = BSDL_CONFIG::Fast::exp2f;
    constexpr auto fast_log2 = BSDL_CONFIG::Fast::log2f;
